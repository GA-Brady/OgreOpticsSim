...
begin
	image_dir = joinpath(pwd(), "images") # setting image directory
	if !isdir(image_dir) # checks if directory exists
		mkdir(image_dir) # creates the directory if it does not exist
	end
end
